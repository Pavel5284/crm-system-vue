...
export const handlePhoneInput = (val: string | number, field: { handleChange: (v: string) => void }) => {
  field.handleChange(truncatePhoneDigits(sanitizePhoneDisplay(String(val ?? ''))))
}
